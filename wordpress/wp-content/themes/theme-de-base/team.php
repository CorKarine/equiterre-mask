...
?>
 <div class="equipe--membre"  data-bs-toggle="modal" data-bs-target="#modal--<?php get_the_ID() ; ?>" id="membre--<?php the_title(); ?>">
	...
	<div class="modal fade" id="modal--<?php get_the_ID() ;?>" tabindex="-1" >
